            ...
            <div className="about-content">
              <div className="section-title1 two mb-50">
                ...
                <h2>
                  ...
                  advice and guidance to organizations seeking to{" "}
                  <span>
                    solve specific problems, improve performance, or achieve
              ...
              <div className="col-xl-7">
                <div className="company-information">
                  <div className="information-content">
                    ...
                    <p>
                      This year is significant because it provides insight into
                      the history and experience of the consulting firm.
                    </p>
                    <ul className="btn-group">
                      <li className="success-rate">
                        Annual Growth <span>90%</span>
                      </li>
                      <li>
                        <span>250+ </span> Team
                      </li>
